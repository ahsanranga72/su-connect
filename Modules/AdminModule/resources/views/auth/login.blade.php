...
<head>
    ...
    <!-- BOOTSTRAP CSS -->
    <link id="style" href="{{asset('assets/admin-module')}}/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    ...
    <!-- COLOR SKIN CSS -->
    <link id="theme" rel="stylesheet" type="text/css" media="all" href="{{asset('assets/admin-module')}}/colors/color1.css" />
            ...
            <div class="">
                ...
                <div class="col col-login mx-auto mt-7">
                    <div class="text-center">
                        <a href="#"><img src="{{asset('assets/admin-module')}}/images/brand/logo-white.png" class="header-brand-img" alt=""></a>
                    </div>
                </div>
